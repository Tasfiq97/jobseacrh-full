...
const JobDetails = () => {
  ...
  const handleApply = () => {
    const applicant =
      applicants.filter((data) => data.email == user.email) || {};
  ...
  return (
    <div className="pt-14 grid grid-cols-12 gap-5 max-w-[1300px]  mx-auto">
      <div className="col-span-9 mb-10">
        ...
        <div className="space-y-5">
          <div className="flex justify-between items-center mt-5">
            ...
            {
              <button disabled={disable} onClick={handleApply} className="btn">
                Apply
              </button>
            }
          </div>
      ...
      <div className="col-span-3">
        <div className="rounded-xl bg-gray-200 p-5 text-primary/80 space-y-5">
          <div>
            <p className="text-black ">Experience</p>
            <h1 className="font-semibold text-lg">{experience}</h1>
          </div>
          <div>
            <p className="text-black ">Work Level</p>
            <h1 className="font-semibold text-lg">{workLevel}</h1>
          </div>
          <div>
            <p className="text-black ">Employment Type</p>
        ...
        <div className="mt-5 rounded-xl bg-gray-200 p-5 text-primary/80  space-y-5">
          <div>
            <h1 className="font-semibold text-lg">{companyName}</h1>
          </div>
          <div>
            <p className="text-black ">Company Size</p>
            <h1 className="font-semibold text-lg">Above 100</h1>
          </div>
          <div>
            <p className="text-black ">Founded</p>
          ...
          <div>
            <p className="text-black ">Company Location</p>
